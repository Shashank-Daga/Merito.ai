    ...
    <section>
      <div className="mx-auto max-w-7xl px-4 py-12 md:py-20">
        <div className="text-centre mb-12">
          <div>
            <h1 className="text-3xl md:text-4xl font-semibold text-balance">Our <span className="text-primary">Origin</span></h1>
        ...
        <div className="text-centre mb-12">
          <div>
            <h1 className="text-3xl md:text-4xl font-semibold text-balance">Our <span className="text-primary">Mission</span></h1>
            <p className="mt-4 leading-relaxed text-pretty text-foreground/80">
        ...
        <div className="text-centre mb-12">
          <div>
            <h1 className="text-3xl md:text-4xl font-semibold text-balance">Our <span className="text-primary">Values</span></h1>

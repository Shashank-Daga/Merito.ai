  ...
  return (
    <section className="py-20 bg-secondary overflow-hidden">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-16">
        {/* Left Image Section */}
        <div className="relative w-full lg:w-1/2 flex justify-center lg:-translate-x-10">
          ...
          <motion.div
            ...
            className="relative w-3/4 rounded-2xl overflow-hidden shadow-md transform translate-y-[-105px]"
          >
            <Image
              src="/process.jpg"
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
            className="absolute bottom-[-150px] right-[-40px] w-[65%] rounded-2xl overflow-hidden shadow-lg"
          >
            <Image
              src="/process1.jpg"
        ...
        <div className="reveal-element w-full lg:w-1/2 mt-16 lg:mt-0 lg:-translate-x-10">
          <div
            className="
              relative bg-white

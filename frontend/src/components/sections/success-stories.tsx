  ...
  return (
    <section className="py-16 px-4 md:px-8 bg-gray-50">
      <div className="mx-auto max-w-7xl">
        <h1 className="text-4xl md:text-5xl font-semibold text-center text-[#003366] mb-12">
          Success Stories
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Success Story 1 */}
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-[#003366] mb-4">Fintech Startup Scales Rapidly</h3>
          ...
          {/* Success Story 2 */}
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-[#003366] mb-4">E-commerce Platform Expands Team</h3>
            <p className="text-gray-600 mb-4">
          ...
          {/* Success Story 3 */}
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-[#003366] mb-4">Healthcare Tech Innovates</h3>
            <p className="text-gray-600 mb-4">
